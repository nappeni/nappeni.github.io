...
$sum_price = $price_sdb1+$price_sdb2+$vat2_pr_add+$vat4_pr_add;
$ot_name = "특허청 등록 결제 (갱신)";
    ...
    <div class="container-fluid px-0">
        <div class="container-xl">
            <div class="division d-block d-xl-flex justify-content-end">
                ...
                <!-- w-65 시작-->
                <form method="post" enctype="multipart/form-data" id="form1" class="w-65 " action="./registered_trademark_renewal_fee_update.php">
        ...
        if(period!=""){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $(".p-period2").html("등록 관납료 ("+period+"년 연장)");
