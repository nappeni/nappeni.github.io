                ...
                <div class="w-65">
                    ...
                    <div class="mb_50 mx_20">
                        ...
                        <div class="bg-light rounded p_20_25 mb_22">
                            <p class="fw_500 fc_gr222 mb-1">심사결과 통지</p>
                            <p class="wh_pre mb-3">특허청 심사 거절 이유 : 사용하는 이미지가 정부가 선정적 또는 부적절함.</p>
                            <p class="wh_pre mb-3">2021년 11월 03일에 마감이 됩니다.
                                상표 출원을 취소하시려면 포기, 심사재개를 진행하시려면 결제를 해주세요.</p>
                            <p class="fc_primary mb_22">결제 금액 : 400,000원</p>
                            ...
                            <div class="btn_group d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-primary btn-md btn_style03" onclick="location.href='applied_trademark_enrollment_payment.php'">결제 후 심사재개 진행</button>
                            </div>

                        </div>

                        <div class="d-flex justify-content-center mb_22">
                            <button type="button" class="btn btn-primary btn-md btn_style03">의견제출통지서 저장</button>
                        </div>
                    </div>
                    <!-- 진행 상황 끝 -->
