                    ...
                    <div class="w-65">
                        ...
                        <div class="form-row">
                            <div class="ip_wr col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="법인 명칭 (한글) 한글로 입력하세요">
                                </div>
                            </div>
                            <div class="ip_wr col-md-6">
                                <div class="ip_tit d-flex align-items-center d-flex  mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="법인 명칭 (한글) 영문으로 입력하세요">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="ip_wr col-md-6 mb-3 mb-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="법인 등록번호 앞자리">
                                </div>
                            </div>
                            <div class="ip_wr col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="법인 등록번호 뒷자리">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="ip_wr col-md-6">
                                <div class="ip_tit d-flex align-items-center d-flex  mb-3">
                                    <h5>사업자 등록번호 <span class="fc_primary">*</span></h5>
                                </div>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="사업자 등록번호를 입력하세요">
                                </div>
                            </div>
                            <div class="ip_wr col-md-6">
                                <div class="ip_tit d-flex align-items-center d-flex  mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="대표자 성명을 입력하세요">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="ip_wr col-md-6 mb-3 mb-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="대표자 주민등록번호 앞자리">
                                </div>
                            </div>
                            <div class="ip_wr col-md-6">
                                <div class="ip_tit align-items-center d-none d-md-flex mb-3 fc_wh">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="대표자 주민등록번호 뒷자리">
                                </div>
                            </div>
                        </div>
