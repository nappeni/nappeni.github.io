                ...
                <div class="w-65">
                    ...
                    <div class="mb_50 mx_20">
                        ...
                        <div class="bg-light rounded p_20_25 mb_22">
                            ...
                            <p class="fc_primary wh_pre">축하드립니다 ! 상표등록이 되었습니다.
                                등록 상표 납부등 정보는 [등록상표 현황] 페이지에서 보실 수 있습니다.</p>
                        </div>

                        <div class="d-flex justify-content-center mb_22">
                            <button type="button" class="btn btn-primary btn-md btn_style03">등록공고 조회 저장</button>
                        </div>
                    </div>
                    <!-- 진행 상황 끝 -->
                    ...
                    <div class="process_information">
                            ...
                            <ul>
                                <li>
                                    <div class="d-flex align-items-center">
                                        <p class="fs_18 fw_600 fc_gr222 mr-2">등록 완료</p>
                                        <span class="fc_graaa">(2021.11.05)</span>
                                    </div>
                                    <ul class="info_list">
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">보고서</p>
                                            <p class="fs_15 a_link"><a href="" class="fc_primary">등록공고.pdf</a></p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <p class="fs_18 fw_600 fc_gr222 mr-2">출원 공고</p>
                                        <span class="fc_graaa">(2021.09.05)</span>
                                    </div>
                                    <ul class="info_list">
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">보고서</p>
                                            <p class="fs_15 a_link"><a href="" class="fc_primary">출원공고서.pdf</a></p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <div class='info_cont'>
                            <ul class="ic_pay">
                                ...
                                <li>
                                    <p class="fs_20 fc_gr222 fw_600 mb_10">심사대응 결제 정보</p>
                                    <div class="bg_lgr rounded-lg p_25_20 pay-info">
                                        <div class="payment">
