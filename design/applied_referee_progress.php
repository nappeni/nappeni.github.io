                ...
                <div class="w-65">
                    ...
                    <div class="mb_50 mx_20">
                        ...
                        <div class="bg-light rounded p_20_25 mb_22">
                            <p class="fw_500 fc_gr222 mb-1">심판 진행</p>
                            <p class="fc_primary wh_pre mb-1">2022년 10월 16일
                                특허청 심판원에 심판청구서를 제출했습니다.</p>
                            <p>심판번호 : [심판번호]</p>
                        </div>

                        <div class="d-flex justify-content-center mb_22">
                            <button type="button" class="btn btn-primary btn-md btn_style03">심판청구서 저장</button>
                        </div>
                    </div>
                    <!-- 진행 상황 끝 -->
                            ...
                            <ul>
                                <li>
                                    <div class="d-flex align-items-center">
                                        <p class="fs_18 fw_600 fc_gr222 mr-2">심판진행</p>
                                        <span class="fc_graaa">(2021.09.05)</span>
                                    </div>
                                    <ul class="info_list">
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">심판번호</p>
                                            <p class="fs_15">[심판번호]</p>
                                        </li>
                                        <li>
