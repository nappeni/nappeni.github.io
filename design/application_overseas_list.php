                    ...
                    <ul class="brand_list oversea mt_30 mb_30">
                        <li class="d-block d-sm-flex">
                            <div class="d-block d-md-flex justify-content-between align-items-center brand_cont">
                                <div class="pr-2">
                                    <p class="fs_20 fc_gr222 fw_600 mb_5">닥터마크1</p>
                                ...
                                <div>
                                    <button type="button" class="btn btn-outline-secondary btn-md" onclick="location.href='application_overseas_information.php'">상세보기</button>
                                </div>
                            </div>
                        </li>
                        <li class="d-block d-sm-flex">
                            <div class="d-block d-md-flex justify-content-between align-items-center brand_cont">
                                <div class="pr-2">
                                    <p class="fs_20 fc_gr222 fw_600 mb_5">닥터마크2</p>
                                    <div class="d-flex align-items-center mb_8">
                                        <div class="d-flex align-items-center fc_gr222 fw_500 w_140">
                                            <i class="xi-timer-o fs_18 mr-2"></i>
                                            <p>접수날짜</p>
                        ...
                        <li class="d-block d-sm-flex">
                            <div class="d-block d-md-flex justify-content-between align-items-center brand_cont">
                                <div class="pr-2">
                                    <p class="fs_20 fc_gr222 fw_600 mb_5">닥터마크3</p>
                                    <div class="d-flex align-items-center mb_8">
                                        <div class="d-flex align-items-center fc_gr222 fw_500 w_140">
                                            <i class="xi-timer-o fs_18 mr-2"></i>
                                            <p>접수날짜</p>
                        ...
                        <li class="d-block d-sm-flex">
                            <div class="d-block d-md-flex justify-content-between align-items-center brand_cont">
                                <div class="pr-2">
                                    <p class="fs_20 fc_gr222 fw_600 mb_5">닥터마크4</p>
                                    <div class="d-flex align-items-center mb_8">
                                        <div class="d-flex align-items-center fc_gr222 fw_500 w_140">
                                            <i class="xi-timer-o fs_18 mr-2"></i>
                                            <p>접수날짜</p>
