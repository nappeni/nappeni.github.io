                ...
                <div class="w-65">
                    ...
                    <div class="mb_50 mx_20">
                        ...
                        <div class="bg-light rounded p_20_25 mb_22">
                            ...
                            <p class="wh_pre mb-3">2022년 09월 08일 등록결정서가 첨부되었습니다.
                                등록료를 결제하여 상표 등록을 완료하세요!</p>
                            <p class="wh_pre mb-3">20212 11월 08일 이후에는 마감되며 납부가 불가능합니다.
                                상표 출원을 취소하시려면 포기, 상표등록을 진행하시려면 결제를 해주세요.</p>
                            <p class="wh_pre  fc_primary mb_22">결제 금액 : 400,000원</p>

                            <div class="btn_group d-flex justify-content-center">
                                <button type="button" class="btn btn-secondary btn-md btn_style03 mr-3" data-toggle="modal" data-target="#give_up">출원 포기</button>
                                <button type="button" class="btn btn-primary btn-md btn_style03" onclick="location.href='applied_trademark_enrollment_payment.php'">등록 납부</button>
                            </div>

                        </div>

                        <div class="d-flex justify-content-center mb_22">
                            <button type="button" class="btn btn-primary btn-md btn_style03">등록결정서 저장</button>
                        </div>
                    </div>
                    <!-- 진행 상황 끝 -->
                    ...
                    <div class="process_information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="info_list">
                                        ...
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">등록료 납부 마감일자</p>
                                            <p class="fs_15">2022년 12월 08일</p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <div class='info_cont'>
                            <ul class="ic_pay">
                                ...
                                <li>
                                    <p class="fs_20 fc_gr222 fw_600 mb_10">특허청 등록 결제 정보</p>
                                    <div class="bg_lgr rounded-lg p_25_20 pay-info">
                                        <ul class="payment_list">
                                            <li>
                                                <p class="fw_500 fc_gr222 mr-2">특허청 관납료</p>
...
<!-- Modal -->
<div class="modal fade" id="give_up" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header align-items-center">
                <h5 class="modal-title" id="exampleModalLabel">출원 포기</h5>
            ...
            <div class="modal-body text-center">
                <p class="mt_50 mb_35 fs_18">
                    정말 <span class="fw_500 fc_gr444">출원을 포기</span>하시겠습니까?<br>
                    <span class="fw_500 fc_gr444">출원 관련 결제 금액은 환불이 불가</span>합니다.
                </p>
            </div>
            <div class="modal-footer">
                <div class="btn_group">
                    <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal">취소</button>
                    <button type="button" class="btn btn-primary btn-lg" onclick="location.href='application_domestic_step3.php'">확인</button>
                </div>
            </div>
        </div>
    </div>
