    ...
    <div class="container-fluid px-0">
        <div class="main_visual">
            <div class="main_bn container-xl">
                <div class="bn_item">
                    <a href="./application_domestic_step1.php" class="d-block">
                        <div class="d-none d-lg-block bn bn1"></div>
                        <img class="d-block d-lg-none w-100" src="./img/main_slide01_m.png">
                    </a>
                </div>
                <div class="bn_item">
                    <a href="./application_domestic_step1.php" class="d-block">
                        <div class="d-none d-lg-block bn bn2"></div>
                        <img class="d-block d-lg-none w-100" src="./img/main_slide02_m.png">
                    </a>
                </div>
                <div class="bn_item">
                    <a href="./application_domestic_step1.php" class="d-block">
                        <div class="d-none d-lg-block bn bn3"></div>
                        <img class="d-block d-lg-none w-100" src="./img/main_slide03_m.png">
                    </a>
                </div>
            </div>
                ...
                <div class="col-12 col-xl-6">
                    <div class="main_qa_top">
                        <div class="d-flex justify-content-xl-start justify-content-center">
                            <strong class="fs_48 fw_600 fc_bdk line_h1_4 br_none text-xl-left text-center">
                                쉽고, 간편하게<br>
                    ...
                    <ul class="main_qa d-sm-block d-none">
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <img src="./img/main_sec1_01.png" alt="">
                            </div>
                        </li>
                        <li class="bg-wh">
                            <div class="d-flex align-items-center">
                                <img src="./img/main_sec1_02.png" alt="">
    ...
    <div class="sec_03_slide mb_55">
        <div class="d-flex align-items-center justify-content-center">
            <ul class="success_story d-flex flex-wrap justify-content-center">
                ...
                <li>
                    <div class="suc_str_top st3"></div>
                    <div class="suc_str_bottom">
                        <div class="d-flex align-items-center mb-2">
                            <strong class="fs_18 fc_gr222 fw_500">등록번호</strong>
                            <p class="fs_18 fc_gr222 fw_600">40-1727803</p>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <strong class="fs_18 fc_gr222 fw_500">등록일</strong>
                            <p class="fs_18">2021.07.20</p>
                        ...
                        <div class="d-flex align-items-center">
                            <strong class="fs_18 fc_gr222 fw_500">지정상품</strong>
                            <p class="fs_18">가정배달음식점업 등</p>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="suc_str_top st4"></div>
                    <div class="suc_str_bottom">
                        <div class="d-flex align-items-center mb-2">
                            <strong class="fs_18 fc_gr222 fw_500">등록번호</strong>
                            <p class="fs_18 fc_gr222 fw_600">40-1660259</p>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <strong class="fs_18 fc_gr222 fw_500">등록일</strong>
                            <p class="fs_18">2021.07.20</p>
