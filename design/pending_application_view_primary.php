            ...
            <div class="division d-block d-xl-flex justify-content-end">
                ...
                <div class="w-65">
                    ...
                    <div class="application_process mb_50">
                        ...
                        <p class="fs_17 fc_gr222 fw_500 mb_10">출원 준비 <span class="fc_primary">1차 수정요청</span></p>
                            ...
                            <ul class="payment_list">
                                <li>
                                    <div class="d-flex align-items-center flex-wrap">
                                        ...
                                        <p class="fc_grccc mr-2">X 3</p>
                                        <p class="fc_grccc">( 지정상품 1, 지정상품2, 지정상품 3 )</p>
                                    </div>
                                </li>
                            </ul>
                            <div class=" border_bk mb_20">
                            </div>
                            <div class="payment">
