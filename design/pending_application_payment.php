                        ...
                        <div class="fd_right">
                            ...
                            <div class="bg-wh rounded-lg p_25_20 mb_22">
                                <ul class="payment_list">
                                    <li>
                                        <p class="fw_500 fc_gr222 mr-2">심사 대응 수수료</p>
                                        <p class="fw_500">30,000원</p>
                                    </li>
                                </ul>
                                <div class="border_bk mb_20"></div>
                                <div class="payment">
                                    <p class="fs_18 fc_gr222 fw_600">결제 금액</p>
                                    <p class="fs_24 fc_bdk fw_600">30,000원</p>
                                </div>
                            </div>
                            ...
                            <div class="ip_wr">
                                ...
                                <div class="input-group mb_10">
                                    <input type="text" class="form-control" placeholder="할인코드 입력">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-primary btn-md" type="button">등록하기</button>
                                    </div>
                                </div>
                                ...
                                <div class="bg-wh rounded-lg p_25_20 br_primary">
                                    <ul class="payment_list">
                                        <li>
                                            ...
                                            <p class="fw_500">30,000원원</p>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center mr-3">
                                                <p class="fw_500 fc_gr222 mr-2">할인율 차감</p>
                                            </div>
                                            <p class="fw_500">0 (0%)원</p>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center mr-3">
                                    ...
                                    <div class="payment">
                                        <p class="fs_18 fc_gr222 fw_600">결제 금액</p>
                                        <p class="fs_24 fc_bdk fw_600">29,000원</p>
                                    </div>
                                </div>
                            </div>
