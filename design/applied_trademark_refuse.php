                ...
                <div class="w-65">
                    ...
                    <div class="mb_50 mx_20">
                        ...
                        <div class="bg-light rounded p_20_25 mb_22">
                            ...
                            <p class="wh_pre mb-3">특허청 거절 이유 : 사용하는 이미지가 선정적 또는 부적절함. </p>
                            <p class="wh_pre mb-3">2022년 11월 14일에 마감이 됩니다.
                                상표 출원을 취소하시려면 포기, 심사청구를 진행하시려면 결제를 해주세요.</p>
                            <p class="fc_primary mb_22">판청구 대응 결제 금액 : 40,000원</p>

                            <div class="btn_group d-flex justify-content-center">
                                <button type="button" class="btn btn-secondary btn-md btn_style03 mr-3">출원 포기</button>
                                <button type="button" class="btn btn-primary btn-md btn_style03" onclick="location.href='application_domestic_step3.php'">거절결정통지서 저장</button>
                            </div>

                        </div>

                        <div class="d-flex justify-content-center mb_22">
                            <button type="button" class="btn btn-primary btn-md btn_style03">결제 후 심판청구 진행</button>
                        </div>
                    </div>
                    <!-- 진행 상황 끝 -->
                    ...
                    <div class="process_information">
                            ...
                            <ul>
                                <li>
                                    <div class="d-flex align-items-center">
                                        <p class="fs_18 fw_600 fc_gr222 mr-2">거절결정 (결제대기)</p>
                                        <span class="fc_graaa">(2021.10.15)</span>
                                    </div>
                                    <ul class="info_list">
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">보고서</p>
                                            <p class="fs_15 a_link"><a href="" class="fc_primary">거절결정통지서.pdf</a></p>
                                        </li>
                                        ...
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">거절결정불복심판 청구 마감일</p>
                                            <p class="fs_15">2021.11.14</p>
                                            <!-- (거절결정일자로부터 30일 후 ) -->
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul class="info_list">
                                        ...
                                        <li class="align-items-start">
                                            <p class="fw_500 fc_gr222 w_150">거절이유</p>
                                            <p class="fs_15 wh_pre">사용하는 이미지가 정부가 선정적 또는 부적절함</p>
                                        </li>
                                        <li>
                                            <p class="fw_500 fc_gr222 w_150">결제금액</p>
                                            <p class="fs_15">60,000원</p>
                        ...
                        <div class='info_cont'>
                            <ul class="ic_pay">
                                ...
                                <li>
                                    <p class="fs_20 fc_gr222 fw_600 mb_10">출원준비 - 2차 수정 요청</p>
                                    <div class="bg_lgr rounded-lg p_25_20 pay-info">
                                        <div class="payment">
                                            <p class="fs_18 fc_gr222 fw_600">결제금액</p>
                                            <p class="fs_24 fc_bdk fw_600">40,000원</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <p class="fs_20 fc_gr222 fw_600 mb_10">의견서 제출 대응</p>
                                    <div class="bg_lgr rounded-lg p_25_20 pay-info">
                                        <div class="payment">
                                            <p class="fs_18 fc_gr222 fw_600">결제금액</p>
                                            <p class="fs_24 fc_bdk fw_600">40,000원</p>
                                ...
                                <li>
                                    <p class="fs_20 fc_gr222 fw_600 mb_10">심판청구 진행 대응</p>
                                    <div class="bg_lgr rounded-lg p_25_20 pay-info">
                                        <div class="payment">
                                            <p class="fs_18 fc_gr222 fw_600">결제금액</p>
                                            <p class="fs_24 fc_bdk fw_600">40,000원</p>
