                    ...
                    <div class="w-65">
                        ...
                        <div class="input-group br_bottom pb_15 mb_22">
                            ...
                            <div class="checks">
                                ...
                                <i class="xi-help fs_19 fc_graaa i_info"></i>
                            </div>
                            <p class="i_cont">대표출원인의 정보를 기재해주시고, 추가될 출원인 정보는 닥터마크 담당자가 집적 요청드릴 예정입니다.</p>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb_50">
                            ...
                            <a href="" class="fc_primary mt_2 a_link">자세히 보기</a>
                        </div>
...
<script>
    $('.i_info').on("click", function() {
        $('.i_cont').addClass('active');
        setTimeout(() => {
            $('.i_cont').removeClass('active');
        }, 2000);
    })
</script>