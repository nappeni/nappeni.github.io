        ...
        <div class="container-xl">
            <div class="division d-block d-xl-flex justify-content-end">
               ...
               <?
                ...
                <?php 
                    $_where = " where ";
                    $_query = "select *, idx as it_idx from inquiry_t";
                    $_query_count = "select count(*) from inquiry_t";
                ...
                ?>
                <div class="w-65">
                    <h2 class="sub_tit">1:1문의 내역</h2>
                    <ul class="brand_list oversea mt_30 mb_30">
                        <?php 
                            $sql_query = $_query.$_where_query."order by idx desc limit ".$n_from.", ".$n_limit;
                        ...
                        <li class="d-block d-sm-flex">
                            <div class="d-block d-md-flex justify-content-between align-items-center brand_cont">
                                <div class="pr-2">
                                    <p class="fs_20 fc_gr222 fw_600 mb_5"><?= $row['qt_title']?></p>
                                    <div class="d-flex align-items-center mb_8">
                                        ...
                                        <p class="fs_15">
                                            <?php 
                                                if($row['qt_status']=="1"){
                                                    echo "<p class='text_bg bg_gre9 fc_gr666 my-1'>접수</p>";
                                                }else{
                                                    echo "답변 완료";
                                                }
                                            ?>
                                    ...
                                    <div class="d-flex align-items-center mb_8">
                                        ...
                                        <p class="fs_15"><?= DateType($row['qt_wdate'],1)?></p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="fs_15">
                                            <?= DateType($row['qt_adate'],1)?>
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-outline-secondary btn-md" onclick="location.href='personal_inquiry_information.php?info=<?= $row['it_idx']?>'">상세보기</button>
                                </div>
                            </div>
                        </li>
                        <?php } 
