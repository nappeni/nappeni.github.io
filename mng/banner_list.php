				...
				<div class="card-body">
						...
						<div class="col-xl-9">
							<div class="float-right">
								<form method="get" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" class="form-inline" onsubmit="return frm_search_chk(this);">
									...
									<div class="form-group mx-sm-1">
										<input type="button" class="btn btn-secondary" value="초기화" onclick="location.href='./banner_list.php'" />
									</div>
									<div class="form-group mx-sm-1">
										<input type="button" class="btn btn-primary" value="신규등록" onclick="location.href='./banner_form.php'" />
									</div>
								</form>
					...
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td class="text-center">
								<input type="button" class="btn btn-outline-primary btn-sm" value="수정" onclick="location.href='./banner_form.php?act=update&bt_idx=<?=$row['bt_idx']?>&<?=$_get_txt.$_GET['pg']?>'" /> <input type="button" class="btn btn-outline-danger btn-sm" value="삭제" onclick="f_post_del('./banner_update.php', '<?=$row['bt_idx']?>');" />
							</td>
						</tr>
						<?
									$counts--;
