				...
				<div class="card-body">
					...
					<div class="row no-gutters mb-2">
						...
						<div class="col-xl-9">
							...
							<form method="get" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" class="form-inline" onsubmit="return frm_search_chk(this);">
								...
								<div class="form-group ml-1">
									<input type="button" class="btn btn-secondary" value="초기화" onclick="location.href='./notice_list.php'" />
								</div>
								<div class="form-group ml-1">
									<input type="button" class="btn btn-primary" value="신규등록" onclick="location.href='./notice_form.php'" />
								</div>
							</form>
					...
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td>
								<p class="text-truncate" style="max-width: 600px;"><?=$row['nt_title']?></p>
							</td>
							<td class="text-center">
								<?=$row['nt_show']?>
							</td>
