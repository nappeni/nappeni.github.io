				...
				<div class="card-body">
					...
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td class="text-center">
								<input type="button" class="btn btn-outline-primary btn-sm" value="수정" onclick="location.href='./member_form.php?act=update&form_type=R&mt_idx=<?=$row['mt_idx']?>&<?=$_get_txt.$_GET['pg']?>'" /> <input type="button" class="btn btn-outline-success btn-sm" value="복구" onclick="f_return_mem('<?=$row['mt_idx']?>');" />
							</td>
						</tr>
						<?
									$counts--;
